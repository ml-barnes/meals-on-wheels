...
class DisplayDriversApp extends React.Component {
  constructor() {
    ...
    this.handleCalendarModalShow = () => {
      this.setState({ showCalendarModal: true });
    };

    this.handleCalendarModalHide = () => {
      this.setState({ showCalendarModal: false });
    };

    this.handleDriverDeletionModalShow = () => {
      this.setState({ showDeleteConfirmationModal: true });
    };

    this.handleDriverDeletionModalHide = () => {
  ...
  getEditData = () => {
    const address = `${serverAddress}find?id=`;
  ...
  handleEditSubmit = () => {
    ...
    fetch(`${serverAddress}updateCustomer`, {
  ...
  getData = () => {
    const address = `${serverAddress}driversList`;
      ...
      <Row key={driver.id} style={detailRowStyle}>
        ...
        <Col>
          <Row>
            ...
            <Col md={10} lg="1">
              <p>{driver.detailData.driverType}</p>
            </Col>
            <Col md={4} lg="3">
        ...
        <Col md="auto">
          <FaRegCalendarAlt onClick={this.handleCalendarModalShow} />{" "}
          <Modal
            show={this.state.showCalendarModal}
            onHide={this.handleCalendarModalHide}
          ...
          <FaTrashAlt onClick={this.handleDriverDeletionModalShow} />{" "}
          <Modal
            show={this.state.showDeleteConfirmationModal}
            onHide={this.handleDriverDeletionModalHide}
          >
            <Modal.Header closeButton>
            ...
            <Modal.Footer>
              <ReactButton
                variant="secondary"
                onClick={this.handleDriverDeletionModalHide}
              >
                Close
              </ReactButton>
              <ReactButton variant="primary">Save Changes</ReactButton>
            </Modal.Footer>
          </Modal>
          <FaEdit onClick={this.handleEditModalShow} />
          <FaEyeSlash />
          <Modal
